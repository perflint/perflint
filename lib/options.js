...
const options = {
  ...
  timeout: [
    't',
    'Define duration before timeout when obtaining results (seconds)',
    'int',
    120
  ],
  ...
  test: [
    false,
    'Obtain results from an existing WebPageTest test',
    'string',
    false
  ],
  ...
  format: [
    'f',
    'Define output format. Available options; stylish',
    'string',
    'stylish'
  ],
  maxWarnings: [
  ...
  server: [
    's',
    'Define the WebPageTest server URL',
    'string',
    'www.webpagetest.org'
  ],
